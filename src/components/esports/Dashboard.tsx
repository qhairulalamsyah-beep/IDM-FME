...
export function Dashboard({
  ...
  const infoTags = [
    ...
    tournament?.lokasi ? { icon: MapPin, label: 'Area', value: tournament.lokasi } : null,
        ...
        >
          ...
          <div className="relative z-10 p-5 md:p-6 lg:p-8">
            ...
            <div className="md:flex md:items-start md:gap-6 lg:gap-8">
                ...
                <div className="md:hidden mb-3.5 flex gap-2.5">
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${isMale ? 'bg-amber-500/20' : 'bg-violet-500/20'}`}>
                        <Trophy className={`w-5 h-5 ${accentColor}`} />
                      </div>
                      <div className="min-w-0">
                        <p className="text-[10px] text-white/35 uppercase tracking-wider font-semibold">Prize Pool</p>
                        <p className={`text-base font-black ${accentColor}`}>Rp {compactPrize(countPrize)}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-emerald-500/20 flex-shrink-0">
                        <Gift className="w-5 h-5 text-emerald-400" />
                      </div>
                      <div className="min-w-0">
                        <p className="text-[10px] text-white/35 uppercase tracking-wider font-semibold">Sawer Pool</p>
                        <p className="text-base font-black text-emerald-400">Rp {compactPrize(totalSawer)}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {/* ── Right Column: Prize Pools + CTA (non-results) OR Results ── */}
              <div className="md:w-72 lg:w-80 md:flex-shrink-0">
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className={`w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 ${isMale ? 'bg-amber-500/20' : 'bg-violet-500/20'}`}>
                          <Trophy className={`w-5 h-5 ${accentColor}`} />
                        </div>
                        <div className="min-w-0 flex-1">
                          <p className="text-[10px] text-white/35 uppercase tracking-wider font-semibold">Prize Pool</p>
                          <p className={`text-lg font-black ${accentColor}`}>Rp {compactPrize(countPrize)}</p>
                        </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="text-[10px] text-white/35 uppercase tracking-wider font-semibold">Sawer Pool</p>
                          <p className="text-lg font-black text-emerald-400">Rp {compactPrize(totalSawer)}</p>
                        </div>
                        <ChevronRight className="w-4 h-4 text-emerald-400/30" />
                      </div>
                    </div>
                  </motion.div>
                </div>
