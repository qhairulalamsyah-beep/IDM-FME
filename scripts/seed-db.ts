...
async function main() {
  ...
  const adminHash = createHash('sha256').update('123456').digest('hex');
  ...
  // Step 3: Create Male Participants
  const maleNames = [
  ...
  // All players including super_admin for rankings
  const allPlayers = [
  ...
  console.log(`Super Admin: 1 (tazos)`);
  console.log(`Male Players: ${maleNames.length}`);
  console.log(`Female Players: ${femaleNames.length}`);
  console.log(`Total Players: ${1 + maleNames.length + femaleNames.length}`);
  console.log(`Clubs: ${createdClubs.length}`);
  console.log(`Tournaments: 2`);
  console.log(`Registrations: ${maleNames.length + femaleNames.length}`);
  console.log(`Donations: ${donationAmounts.length}`);
  console.log(`Rankings: ${1 + maleNames.length + femaleNames.length}`);
  console.log('===================================');
}
